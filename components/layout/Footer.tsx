            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-6 lg:grid-cols-12 gap-12 lg:gap-20 mb-20 text-center md:text-left">
                    <div className="md:col-span-3 lg:col-span-4 space-y-8">
                        <Link href="/" className="flex items-center space-x-2">
                            ...
                            <span className="text-2xl font-bold tracking-tight text-gray-900">StyleNest</span>
                        </Link>
                    ...
                    <div className="md:col-span-3 lg:col-span-2 space-y-6">
                        <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-900">Curation</h4>
                    ...
                    <div className="md:col-span-3 lg:col-span-2 space-y-6">
                        <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-900">Identity</h4>
                        <ul className="space-y-4">
                    ...
                    <div className="md:col-span-3 lg:col-span-4 space-y-8">
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-gray-900">Join the Elite</h4>
                        ...
                        <div className="flex gap-2">
                            ...
                            />
                            <button 
                                className="bg-primary text-white px-6 py-3 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-vital transition-vibrant shadow-lg shadow-primary/20"
                                suppressHydrationWarning
                            >
                                JOIN
                            </button>
                ...
                <div className="border-t border-gray-100 pt-10 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                        © 2024 StyleNest. All rights reserved.
                    </div>
                    <div className="flex items-center space-x-2">
                        {['Visa', 'Mastercard', 'Amex', 'PayPal'].map((p) => (
                            <div key={p} className="h-8 w-12 bg-white border border-gray-100 rounded flex items-center justify-center text-[8px] font-bold text-gray-400">{p}</div>
                        ))}
                    </div>
                </div>
            </div>
